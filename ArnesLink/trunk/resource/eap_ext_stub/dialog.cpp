   ...
   PSW2_USER_DATA	pUserData;
    ...
    switch( unMsg )
    {
		case WM_INITDIALOG:
			...
			SW2Trace( SW2_TRACE_LEVEL_DEBUG, TEXT( "CredentialsDlgProc:: WM_INITDIALOG" ) );
			...
			SW2Trace( SW2_TRACE_LEVEL_DEBUG, TEXT( "CredentialsDlgProc:: WM_INITDIALOG:: returning" ) );
	    ...
	    case WM_COMMAND:
			...
			switch( LOWORD( wParam ) )
			{
				case IDOK:
					...
					SW2Trace( SW2_TRACE_LEVEL_DEBUG, TEXT( "CredentialsDlgProc::IDOK" ) );

					pUserData = ( PSW2_USER_DATA ) GetWindowLongPtr( hWnd, GWLP_USERDATA );


					SW2Trace( SW2_TRACE_LEVEL_DEBUG, TEXT( "CredentialsDlgProc::pwcIdentity: %ld" ), GetWindowTextLength( GetDlgItem( hWnd, IDC_CRED_IDENTITY ) ));
