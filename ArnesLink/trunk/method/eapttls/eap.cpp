									 ...
									 IN	PSW2EAPOUTPUT		pEapOutput )
{
	...
	switch( pSessionData->InnerSessionData.InnerEapState )
	{
		case SW2_INNER_EAP_STATE_Start:
			...
			SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPHOSTAuthentication::EAP::SW2_INNER_EAP_STATE_Start" ) );
			...
			{
				SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPHOSTAuthentication::EAP::not enough memory" ) );
		...
		case SW2_INNER_EAP_STATE_MakeMessage:
			...
			if( pSessionData->TLSSession.pbInnerEapMessage )
			{
				...
				SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::EAP::SW2_INNER_EAP_STATE_MakeMessage:pInnerEapHostReceivePacket(%ld)" ), 
								 ...
								 IN	PSW2EAPOUTPUT		pEapOutput )
{
	...
	switch( pSessionData->InnerSessionData.InnerEapState )
	{
		case SW2_INNER_EAP_STATE_Start:
			...
			SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::EAP::SW2_INNER_EAP_STATE_Start" ) );
			...
			if ((dwReturnCode = SW2AllocateMemory(ccInnerEapIdentity + 1, (PVOID*) &pcInnerEapIdentity)) == NO_ERROR)
			{
				WideCharToMultiByte( CP_ACP, 0, 
					pSessionData->UserData.InnerEapUserData.pwcIdentity, -1, pcInnerEapIdentity, ccInnerEapIdentity + 1, NULL, NULL );
			}
			...
			if( dwReturnCode == NO_ERROR )
			{
				if( ( dwReturnCode = AuthMakeEAPResponseAttribute( &(pSessionData->TLSSession), 
																	...
																	( PBYTE ) pcInnerEapIdentity, ccInnerEapIdentity, 
																	&pbEAPAttribute, &cbEAPAttribute ) ) == NO_ERROR )
				{
					if( ( dwReturnCode = AuthMakeDiameterAttribute( 0x4F, 
																	pbEAPAttribute, cbEAPAttribute, 
																	&pbEAPAVP, &cbEAPAVP ) ) == NO_ERROR )
					{
		...
		case SW2_INNER_EAP_STATE_InteractiveUI:
			...
			SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::SW2_INNER_EAP_STATE_InteractiveUI" ) );
		...
		case SW2_INNER_EAP_STATE_MakeMessage:
			...
			SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::EAP::SW2_INNER_EAP_STATE_MakeMessage" ) );
					...
					switch( pInnerEapReceivePacket->Code )
					{
						case EAPCODE_Request:
							...
							SW2Trace( SW2_TRACE_LEVEL_INFO, 
								TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::SW2_INNER_EAP_STATE_MakeMessage::EAPCODE_Request" ) );
																				...
																				&pbEAPAVP, &cbEAPAVP ) ) == NO_ERROR )
									{
										if( pSessionData->TLSSession.cbState > 0 )
										{
											...
											if( ( dwReturnCode = AuthMakeDiameterAttribute( 0x18, 
																			...
																			&cbStateAVP ) ) == NO_ERROR )
											{
												cbAVP = cbEAPAVP  + cbStateAVP;

												if ((dwReturnCode = SW2AllocateMemory(cbAVP, (PVOID*) &pbAVP)) == NO_ERROR)
												{
													memcpy( pbAVP, pbEAPAVP, cbEAPAVP );
													memcpy( pbAVP + cbEAPAVP, pbStateAVP, cbStateAVP );
												}
												
												SW2FreeMemory((PVOID*)&pbStateAVP);
												cbStateAVP = 0;
											}
										}
										else
						...
						case EAPCODE_Success:
							...
							SW2Trace( SW2_TRACE_LEVEL_INFO, 
								TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::SW2_INNER_EAP_STATE_MakeMessage::EAPCODE_Success" ) );
						...
						case EAPCODE_Failure:
							...
							SW2Trace( SW2_TRACE_LEVEL_INFO, 
								TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::SW2_INNER_EAP_STATE_MakeMessage::EAPCODE_Failure" ) );
				...
				( dwReturnCode == NO_ERROR ) )
			{
				...
				if ((dwReturnCode = SW2AllocateMemory(cbInnerEapSendPacket, (PVOID*) &pInnerEapSendPacket)) == NO_ERROR)
				{
											...
											&( pSessionData->InnerSessionData.InnerEapInput ) ) ) == NO_ERROR )
					{
						...
						{
							SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthHandleInnerEAPAuthentication::inner eap method requested interactive ui" ) );
					...
					{
						SW2Trace( SW2_TRACE_LEVEL_ERROR, TEXT( "SW2_TRACE_LEVEL_ERROR::AuthHandleInnerEAPAuthentication::pInnerEapMakeMessage FAILED: %ld" ), dwReturnCode );
					}
		...
		case SW2_INNER_EAP_STATE_Finished:
			...
			SW2Trace( SW2_TRACE_LEVEL_ERROR, TEXT( "SW2_TRACE_LEVEL_ERROR::AuthHandleInnerEAPAuthentication::invalid state (SW2_INNER_EAP_STATE_Finished)" ) );
		...
		default:
			...
			SW2Trace( SW2_TRACE_LEVEL_ERROR, TEXT( "SW2_TRACE_LEVEL_ERROR::AuthHandleInnerEAPAuthentication::unknown inner authentication state" ) );
								...
								OUT DWORD *pcbEAPAttribute )
{
	...
	SW2Trace( SW2_TRACE_LEVEL_INFO, TEXT( "SW2_TRACE_LEVEL_INFO::AuthMakeEAPResponseAttribute::returning %ld" ), dwReturnCode );
